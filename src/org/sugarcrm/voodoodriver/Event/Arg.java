 ...
 * The arg event.
 *
 * <p>The arg event is a nop.  It is used only as a child event of
 * javaplugin and execute.  This code is here to simplify event
 * parsing.</p>
 *
 * @author Jon duSaint
 */

class Arg extends Event {


   /**
    * Instantiate an arg event.
    *
    * @param e  the event as specified in the test script
    * @throws VDDException if event instantiation fails
    */

   public Arg(Element e) throws VDDException {
      super(e);
   }
